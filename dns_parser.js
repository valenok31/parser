...
let link = 'https://www.dns-shop.ru/catalog/17aa4c1d16404e77/trimmery/?stock=now-today-tomorrow&p=';
        ...
        await page.waitForSelector('div.product-card-description-text', {timeout: 15000})
            ...
            .then(async () => {
                ...
                let html = await page.evaluate(async () => {
                    ...
                    // !!Для скачивания всех фото на detmir.ru!!
                    ...
                    let obj = {
                        ...
                        'Минимальная длина стрижки, мм': '',
                        'Максимальная длина стрижки, мм': '',
                        'Особенности бритв, триммеров, эпиляторов': '',
                    ...
                    for (let k = 0; k < child.length; k++) {
                        for (let i = 1; i < child[k].childNodes.length; i++) {
                            ...
                            if (title == 'Ширина' || title == 'Высота' || title == 'Глубина' ) {
